...
class AdversarialNLIDataModule(SNLIDataModule):
    ...
    def __init__(self, d_params: dict, tokenizer: object = None):
        ...
        # hard-coded stuff
        self.path = "anli"  # hf_datasets will handle everything
    ...
    def setup(self, stage: str = None):
        ...
        self.dataset['train'] = self.dataset['train_r3']
        self.dataset['validation'] = self.dataset['dev_r3']
        self.dataset['test'] = self.dataset['test_r3']
        del self.dataset['train_r1']
        del self.dataset['train_r2']
        del self.dataset['dev_r1']
        del self.dataset['dev_r2']
        del self.dataset['test_r1']
        del self.dataset['test_r2']
