...
class MultiNLIDataModule(SNLIDataModule):
    ...
    def __init__(self, d_params: dict, tokenizer: object = None):
        ...
        self.domain = d_params.get("domain", "matched")
    ...
    def setup(self, stage: str = None):
        ...
        # get subset of data according to domain
        if self.domain == "matched":
            self.dataset['validation'] = self.dataset['validation_matched']
            del self.dataset['validation_mismatched']
        else:
            self.dataset['validation'] = self.dataset['validation_mismatched']
            del self.dataset['validation_matched']
