...
class Hopfield(Module):
    ...
    def __init__(self,
        ...
        self.association_core = HopfieldCore(
            embed_dim=input_size, alpha=alpha, sparsemap = sparseMAP, Seq_budget = Seq_budget, k = k, num_heads=num_heads, dropout=dropout, bias=input_bias,
    ...
    def forward(self, input: Union[Tensor, Tuple[Tensor, Tensor, Tensor]],
        ...
        association_output = self._maybe_transpose(weights)
        if self.association_activation is not None:
            association_output = self.association_activation(weights)
        return association_output, z
...
class HopfieldPooling(Module):
    ...
    def __init__(self,
        ...
        self.hopfield = Hopfield(
            ...
            num_heads=num_heads, alpha = alpha, sparseMAP=sparseMAP, Seq_budget=Seq_budget, k=k, scaling=scaling, update_steps_max=update_steps_max, update_steps_eps=update_steps_eps,
    ...
    def forward(self, input: Union[Tensor, Tuple[Tensor, Tensor]], stored_pattern_padding_mask: Optional[Tensor] = None,
        ...
        return out.flatten(start_dim=1), z
